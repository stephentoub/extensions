...
/// </remarks>
public sealed class CodeInterpreterTool : AITool
{
    /// <summary>Gets a singleton instance of <see cref="CodeInterpreterTool"/>.</summary>
    public static CodeInterpreterTool Instance { get; } = new();

    private CodeInterpreterTool()
    {
    }
}

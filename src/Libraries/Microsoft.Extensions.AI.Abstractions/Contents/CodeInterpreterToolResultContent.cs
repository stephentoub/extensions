...
/// </summary>
/// <remarks>
/// This content type captures the output from a hosted code interpreter tool execution.
/// The <see cref="Output"/> property contains the execution results,
/// which may include <see cref="TextContent"/> for stdout/stderr, <see cref="DataContent"/> or
/// <see cref="HostedFileContent"/> for generated files, or other <see cref="AIContent"/> types.

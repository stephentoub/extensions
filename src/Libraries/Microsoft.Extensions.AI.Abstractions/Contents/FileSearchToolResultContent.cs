...
/// <summary>
/// Represents the result of a file search tool invocation by a hosted service.
/// </summary>
/// <remarks>
/// This content type captures the output from a hosted file search tool execution.
/// The <see cref="Output"/> property contains the search results,
/// which typically include <see cref="TextContent"/> for relevant excerpts,
/// metadata about source files, or other <see cref="AIContent"/> types.
/// It is informational only.
/// </remarks>
[Experimental("MEAI001")]
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public sealed class FileSearchToolResultContent : AIContent
{
    /// <summary>
    /// Initializes a new instance of the <see cref="FileSearchToolResultContent"/> class.
    /// </summary>
    ...
    public FileSearchToolResultContent(string callId)
    {
